...
function mobileMenuData(prefix) {
    ...
    if($('.list-ico').attr('src')== prefix + 'common/main/img/list_button_ico.png') {
        $('.list-ico').attr('src', prefix + 'common/main/img/list_exit_ico.png');
    } else {
        $('.list-ico').attr('src', prefix + 'common/main/img/list_button_ico.png');
    }   
}
